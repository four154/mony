var rid='190bf7a3eb0x0e0026x-si3xhu';
...
$(`<style>
.nosel.d-flex.room.r190bf7a3eb0x0e0026x-si3xhu .fitimg.u-pic.borderg {
  letter-spacing: 1px;
  background-size: 108% 108%;
  -webkit-text-fill-color: white;
  animation: grad 2s cubic-bezier(.445,.05,.55,.95) alternate infinite;
}
.nosel.d-flex.room.r190bf7a3eb0x0e0026x-si3xhu .corner.fa.fa-user.label.uc.fa-microphone.label-danger {
  letter-spacing: 1px;
...
.nosel.d-flex.room.r190bf7a3eb0x0e0026x-si3xhu.bord {border-inline: 0px solid #4c121e !important;}
.nosel.d-flex.room.r190bf7a3eb0x0e0026x-si3xhu .dots.mini.u-msg {
    text-align: center;
...
.nosel.d-flex.room.r190bf7a3eb0x0e0026x-si3xhu {
    background-image: url(https://up6.cc/2024/07/172109084592671.gif);
...
.nosel.d-flex.room.r190bf7a3eb0x0e0026x-si3xhu .u-topic.dots {
...
#upro.l7dah1 .modal-header.label-primary {
  ...
  background-color: #b17085!important;
  background-image: url(https://up6.cc/2024/07/172109311023863.png);
  background-size: cover;
}
...
#d0.l7dah1 .label-primary {
    ...
    border-radius: 10px 0 10px!important;
    background-image: url(https://up6.cc/2024/07/172109311022672.png);
    color: #b17085;
    background-size: 100%;
}
...
.modal-header.label-primary.l7dah1 {
	border-radius:  10px 0 10px!important;
    border: 1px solid #b3919c;
    background-color: #8f4d62!important;
	background-image: url(https://up6.cc/2024/07/172109311023863.png);
    background-size: cover;
}
...
setInterval(function () {
    if (myroom == '190bf7a3eb0x0e0026x-si3xhu') {
        if (l7dah == false) {
            l7dah = true;
